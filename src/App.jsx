...
const contact = {
  ...
  email: "hello@duma-digital.vercel.app",
};
...
function DreamMark({ className = "" }) {
  ...
  return (
    <div className={`logo-aura relative ${className}`} aria-label="DUMA AI Agency logo">
      <svg viewBox="0 0 220 220" className="h-full w-full" role="img">
        ...
        <circle cx="110" cy="110" r="74" fill="none" stroke="url(#dumaAiGlow)" strokeWidth="4" />
        <circle cx="110" cy="110" r="14" fill="#10B981" />
        {[0, 60, 120, 180, 240, 300].map((angle) => (
          <line
            key={angle}
            x1="110"
            y1="110"
            x2={110 + 66 * Math.cos((angle * Math.PI) / 180)}
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 border-b border-mint/10 bg-night/[0.72] backdrop-blur-2xl">
      <nav className="container-x flex h-20 items-center justify-between">
        <a href="#top" className="flex items-center gap-3" aria-label="DUMA AI Agency home">
      ...
      <div className="container-x grid min-h-[calc(100vh-7rem)] items-center gap-12 py-16 lg:grid-cols-[1fr_0.84fr]">
        ...
        <div className="relative mx-auto flex aspect-square w-full max-w-[540px] items-center justify-center">
          ...
          <div className="ai-core glass relative z-10 flex h-[78%] w-[78%] items-center justify-center rounded-full">
            ...
            <span className="absolute right-12 top-16 rounded-full border border-gold/40 bg-night/70 px-4 py-2 text-xs font-black uppercase tracking-[0.22em] text-gold">
              AI
            </span>
          </div>
        </div>
    ...
    <div className="modal-shell" role="dialog" aria-modal="true" aria-labelledby="service-title">
      ...
      <article className="modal-card glass">
        ...
        <div className="service-banner">
          <div>
            <p className="mb-4 text-xs font-black uppercase tracking-[0.22em] text-gold">DUMA AI Service</p>
  ...
  return (
    <footer className="border-t border-mint/10 py-8">
      <div className="container-x flex flex-col items-center justify-between gap-5 text-center md:flex-row md:text-left">
        ...
        <p className="text-sm text-mint/[0.45]">Copyright 2026 DUMA AI Agency. All rights reserved.</p>
      </div>
    </footer>
  );
}
